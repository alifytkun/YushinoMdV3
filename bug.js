...
rows: [
{ title: '😈⛓𝑩𝒖𝒈 𝑷𝒅𝒇̶᭄࿐ꪶ😈 BOT ALIF', rowId: `${_p}${command} pdf ${text}` },
{ title: '😈⛓𝑩𝒖𝒈 𝑪𝒂𝒕𝒂𝒐𝒄̶̶̶᭄࿐ꪶ😈BOT ALIF', rowId: `${_p}${command} bugcatalog ${text}` },
{ title: '😈⛓𝑩𝒖𝒈 𝑽𝒏̶᭄࿐ꪶ😈BOT ALIF', rowId: `${_p}${command} vn ${text}` },
{ title: '😈⛓𝑩𝒖𝒈 𝑺𝒕𝒊𝒄𝒌̶᭄࿐ꪶ😈BOT ALIF', rowId: `${_p}${command} sticker ${text}` },
{ title: '😈⛓𝑩𝒖𝒈 𝑰𝒎𝒈̶᭄࿐ꪶ😈BOT ALIF', rowId: `${_p}${command} bugimg ${text}` },
{ title: '😈⛓𝑩𝒖𝒈 𝑽𝒊𝒅𝒆𝒐̶᭄࿐ꪶ😈BOT ALIF', rowId: `${_p}${command} bugvid ${text}` },
{title: '😈⛓𝑩𝒖𝒈 𝑰𝒏𝒗𝒊𝒕𝒆࿐ꪶ😈BOT ALIF', rowId: `${_p}${command} buginvite ${text}` },
{ title: '😈⛓𝑩𝒖𝒈 𝑪𝒓𝒂𝒔𝒉̶᭄࿐ꪶ😈BOT ALIF', rowId: `${_p}${command} bugcrash ${text}` },
{ title: '😈⛓𝑩𝒖𝒈 𝑲𝒐𝒏𝒕𝒂𝒌̶᭄࿐ꪶ😈BOT ALIF', rowId: `${_p}${command} bugkontak ${text}` }, 
{ title: '😈⛓𝑩𝒖𝒈 𝑹𝒆𝒂𝒄𝒕𝑷𝒄̶᭄࿐ꪶ😈BOT ALIF', rowId: `${_p}${command} reactpc ${text}` },        
{ title: '😈⛓ dengan𝑩𝒖𝒈 𝑻𝒆𝒙𝒕 𝑪𝒓𝒂𝒔𝒉̶᭄࿐ꪶ😈BOT ALIF', rowId: `${_p}${command} bugtextcrash ${text}` },]}]
    let listMessage = {
      text: '😈⛓𝐀𝐋IV࿐ꪶ😈',
      footer: '*➳😈⛓⚔w̆̈e̶ 𝐀L𝐀𝐇
     AL𝑰𝑽࿐ꪶ😈💯☚༻*    🦟 ⃢⃢  ⃢⃢  ⃢⃢  ⃢⃢  ⃢⃢  ⃢⃢  ⃢⃢  *꧁ᱝ✞☛͜⧼🥶⃟⚔w̆̈e̶ ă̈r̶e̶⧽͜🥵͜🔥☚✞ᱝ꧂* *重難重難重難重x難重難重難重難重重* *☛⧼͜🥶ꮗꮛ ꮢꮛ ꮑꮗꮥꮢ⧽͜👹🔥ᴷⁱⁿᵍ ʰᵘⁿᵗᵉʳ❗...༒⚞⚔n̷w̷s̷r̷࿐⚟༒...❗* *重難重難重難重難重難重難重難重重* *๑๑๑615๑๑* *๕๕๗๗๓๓๓๓* *๕๕๕๕๗๗๕๕*➳👹⚔w̆̈e̶ 𝐀𝐋𝐃𝐈 𝐍𝐈 𝐁𝐎𝐙̶᭄𝐍𝐖𝐒𝐑࿐🇱🇰☚༻*‼️💉💉🩸•𝚋𝚘𝚝𝚣•🩸💉💉‼️•☠•(༒⃟⃢❰❍❱•𝐗 𝐀𝐢𝐬𝐲𝐚𝐡•➣⃟۝⃟°)•⁩☠•*.㍙.㍙.㍝.㍙.㍝.㍝.㍙.㍝.㍞.cc* *~.1.1.5.𫟅.▓.者.▓.1.5.5.𫟅.▓.8者.▓.𫟅.█.1.5.6.؋.cc~* �*.㍙.㍙.㍝.㍙.㍝.㍝.㍙.㍝.㍞.cc* *~.1.1.5.𫟅.▓.者.▓.1.5.5.𫟅.▓.者.▓.𫟅.█.1.5.6.؋.cc~*  ۦོ͢✘ ✘͢͢ۦོ͢✘⃢ᡃ⃢ᡃ⃢⃟⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ ᡃ⃟ᡃ⃟ᡃ⃟ᡃ⃟ᡃᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃟⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢⃟⃢ᡃ⃟⃟⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢⃟⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ ✘͢͢ ✘͢͢ ⇣͢✘͢͢⁦  ✘͢͢ۦོ͢✘͢͢ᡃ⃟  ᡃ⃟ᡃ⃟ ᡃ⃟ᡃ⃟ᡃ⃟ᡃ⃟ᡃᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃢ᡃ⃟⃟⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢⃟⃢ᡃ⃟⃟⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ⃢⃟⃢ᡃ⃢ᡃ⃢ᡃ⃢ᡃ',
